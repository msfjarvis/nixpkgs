...
def prefetch_pnpm(lock_file: str):
    print(f"Prefetching pnpm deps")

    hash = run_external(["nix", "hash", "file", "--type", "sha256", lock_file])
...
if __name__ == "__main__":
    ...
    pnpm_hash = prefetch_pnpm(f"{src['path']}/ui/v2.5/pnpm-lock.yaml")
